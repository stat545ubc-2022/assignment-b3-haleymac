...
**For this assignment I have chosen option B and have created my own shiny app**

This repository contains the source code for a shiny app that allows a user to explore the vancouver trees dataset through several interactive features, including a coordinate plot and a customizable table. 
